...
<body>
	...
	<form action=' <st:url value="/Manager/updateUserInfo.do"></st:url>'
		...
		<div class="formbody">
			...
			<ul class="forminfo">
				<li><label>工号：</label><input name="nickName" type="text"
					class="dfinput" value="${userInfo.nickName}" /><i></i></li>
				<li><label>手机：</label><input name="Phone" id="PhoneNum" oninput="inputChange()" type="text"
				...
				<li><label>载重(吨)：</label><input name="shippington" type="text"
					class="dfinput" value="${userInfo.shippington}" /><i></i></li>
					<li><label>移动GPS编码：</label><input id="gpsimei" name="gpsimei" type="text"
					class="dfinput"  value="${userInfo.gpsimei}" /><i></i></li>
