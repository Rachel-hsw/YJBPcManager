            ...
            <div class="layui-row">
                <div class="layui-col-xs4">
                    <div class="layui-inline">
                        ...
                        <div class="layui-input-inline purchasingunit">
                            <input type="text" class="layui-input" disabled placeholder="双击选择" value="${FName}"  >
                ...
                <div class="layui-col-xs4">
                    <div class="layui-inline">
                        ...
                        <div class="layui-input-inline select182">
                            <select name="FIsDefault" class="layui-input" required>
                ...
                <div class="layui-col-xs4">
                    <div class="layui-inline">
                        ...
                        <div class="layui-input-inline select182">
                            <select name="FPayment_id" class="layui-input" required>
                ...
                <div class="layui-col-xs4">
                    <div class="layui-inline">
                        ...
                        <div class="layui-input-inline ">
                            <input type="text" class="layui-input" placeholder="" name="FS_Date" value="<%=new SimpleDateFormat("yyyy-MM-dd HH:mm:ss").format(new java.util.Date())%>" >
                        </div>
                    </div>
                </div>
                <div class="layui-col-xs4">
                    <div class="layui-inline">
                        ...
                        <div class="layui-input-inline">
                            <input type="text" class="layui-input" value="" name="FPay_Id" required>
                        </div>
                    </div>
                </div>
                <div class="layui-col-xs4">
                    <div class="layui-inline">
                        ...
                        <div class="layui-input-inline">
                            <input type="text" class="layui-input"  name="FFk_Zje" required>
                        </div>
                    </div>
                </div>
            </div>
            <div class="layui-row">
                <div class="layui-col-xs4">
                    <div class="layui-inline">
                        ...
                        <div class="layui-input-inline">
                            <input type="text" class="layui-input"  name="FSxf" required>
                        </div>
                    </div>
                </div>
                <div class="layui-col-xs4">
                    <div class="layui-inline">
                        ...
                        <div class="layui-input-inline">
                            <input type="text" class="layui-input money"  readonly name="FFk_Je" required>
                        </div>
                    </div>
                ...
                <div class="layui-col-xs4">
                    <div class="layui-inline">
                        ...
                        <div class="layui-input-inline">
                            <input type="text" class="layui-input"  name="FZdy" required>
                        </div>
                    </div>
                </div>
            </div>
            <div class="layui-row">
                <div class="layui-col-xs4">
                    <div class="layui-inline">
                        ...
                        <div class="layui-input-inline">
                            <input type="text" class="layui-input" name="FPay_Name" required>
                        </div>
                    </div>
                </div>
                <div class="layui-col-xs4">
