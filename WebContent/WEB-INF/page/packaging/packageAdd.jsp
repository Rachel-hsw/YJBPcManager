...
<!--=====表格开始====-->
 <form action="${pageContext.request.contextPath}/Manager/packageAddSubmit.do" id="selectForm"
		method="post"  > 
<div class="container ">
	<div class="form-inline" style="padding: 20px 0;">
		<div class="form-group">
			<label for="P_Package">套餐名称：</label>
			<input class="form-control" required type="text" id="P_Package" name="" value=""/>
		</div>&nbsp;&nbsp;&nbsp;&nbsp;
		<div class="form-group">
			<label for="P_Remark">备注：</label>
			<input  class="form-control" required type="text" id="P_Remark" value=""/>
		</div>
	</div>
    ...
    <table class="table table-bordered table-hover">
        ...
        <tr class="prolist">
            ...
            <td class='t4' style="padding:0;"><input type="text" style="width:100%;height:100%; text-indent:10px;" readonly="readonly"/></td>
            <td class='t5'><input type="text"  readonly="readonly"/></td>   
...
<input type="button" class="btn btn-warning pull-right" value="生成套餐√" id="complete"> 
	</form>
</div>
...
$("#complete").click(function () {
	$("#selectForm").find("input[type='hidden']").remove();
	var num=0;
	var money=0;
   $("tr td .check").each(function(i){
	   if($(this).is(':checked')){
		 //  alert("dfsf");//P_ZNum,	P_ZMoney,P_Remark
		   console.log(i);
		    var P_Id=$(this).val();
		    var P_Num=$(this).parent().siblings("td").eq(3).find("input").val();
		    var P_Money=$(this).parent().siblings("td").eq(4).find("input").val();
