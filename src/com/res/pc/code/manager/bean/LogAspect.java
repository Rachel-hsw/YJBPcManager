...
public class LogAspect {
	 ...
	 * @param joinPoint
	 */
	@Before("execution(* com.res.pc.code.manager.ManagerConntroller..*.*(..))")
	 ...
	 * @param joinPoint
	 */
	@After("execution(* com.res.pc.code.manager.ManagerConntroller..*.*(..))")
	 ...
	 * @throws Throwable
	 */
	@Around("execution(* com.res.pc.code.manager.ManagerConntroller..*.*(..))")
