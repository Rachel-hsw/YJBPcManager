...
public class ExportExcelSeedBack {
    ...
    //构造方法，传入要导出的数据
    public ExportExcelSeedBack(String title,String[] rowName,List<Object[]> dataList,int isneedtitle){
    ...
    public void export(OutputStream out) throws Exception{
        try{
            ...
            HSSFCellStyle titleStyle = this.getTitleStyle(workbook);//获取列头样式对象
            ...
            for(int i=0;i<dataList.size();i++){
                ...
                HSSFRow row = sheet.createRow(num+i+1);//创建所需的行数（从第二行开始写数据）
